/**
 * Shared components for b2bvic.com — "The Operator" design system.
 * Dark theme, amber accent, Sora typography.
 *
 * Exports: megaNavHtml, megaNavStyles, megaNavScript, footerHtml, headIncludes, tailwindConfig, entityDomains
 */
    ...
    <div class="max-w-6xl mx-auto">
      <div class="flex items-center justify-between h-16 px-6">
        ...
        <div class="hidden lg:flex items-center gap-1">
          ...
          <!-- The System (SWS) -->
          <a href="https://scalewithsearch.com" target="_blank" rel="me" class="nav-link px-4 py-2 text-sm text-amber-500 hover:text-amber-400 transition-colors font-body font-500">The System &rarr;</a>
    ...
    <div class="max-w-6xl mx-auto px-6">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><a href="https://scalewithsearch.com" target="_blank" rel="me" class="text-amber-500 hover:text-amber-400 transition-colors font-medium">Scale With Search &rarr;</a></li>
            <li><a href="https://github.com/b2bvic/scale-with-search" target="_blank" class="text-zinc-400 hover:text-white transition-colors">Open Source Repo</a></li>
      ...
      <div class="pt-8 border-t border-zinc-800/60 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p class="text-xs text-zinc-700">Part of the <a href="https://scalewithsearch.com" target="_blank" class="text-zinc-500 hover:text-amber-500 transition-colors">Scale With Search</a> network &middot; <a href="https://github.com/b2bvic/scale-with-search" target="_blank" class="text-zinc-500 hover:text-amber-500 transition-colors">Open Source</a></p>
      </div>
    </div>
  </footer>`;
